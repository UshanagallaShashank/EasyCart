...
export const store_name_schema = z.string().trim().min(2, 'Store name must be at least 2 characters').max(60, 'Store name must not exceed 60 characters');
